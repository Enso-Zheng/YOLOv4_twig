...
parser.add_argument('--image_path', help="Path of image to detect objects", default="26.jpg")
parser.add_argument('--verbose', help="To print statements", default=True)
parser.add_argument('--weight', help="weight")
parser.add_argument('--cfg', help="cfg")
parser.add_argument('--names', help="names")
parser.add_argument('--width', help="names", default=640)
parser.add_argument('--height', help="names", default=480)
args = parser.parse_args()


#Load yolo
def load_yolo():
	net = cv2.dnn.readNet(str(weight),str(args.cfg))
	classes = []
	with open(str(names), "r") as f:
